...
// TODO[phase-17-merge]: replace stub with real import from
// './spatial-audio-bus.js' after Track A merges. Track A's branch is
// claude/phase-17-1-spatializer.
...
export interface SpatialAudioBus {
  playPositional(
    buffer: AudioBuffer,
