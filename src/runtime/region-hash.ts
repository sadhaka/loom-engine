...
export function regionHash(key: string | Uint8Array, regionState: unknown): string {
...
export function regionLeaves(key: string | Uint8Array, regions: Record<string, unknown>): Record<string, string> {
  var leaves: Record<string, string> = {};
...
export function globalRegionHash(key: string | Uint8Array, regions: Record<string, unknown>): string {
...
export function verifyRegion(key: string | Uint8Array, regionState: unknown, expectedHash: string): boolean {
