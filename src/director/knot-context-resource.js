...
export class KnotContextResource {
    ...
    beginFade(targetHex, fadeMs, nowMs) {
...
function interpolatePaletteInto(from, to, t, out) {
...
//# sourceMappingURL=knot-context-resource.js.map