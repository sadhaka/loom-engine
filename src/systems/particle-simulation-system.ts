...
import { ParticlePool, PARTICLE_FLAG_ALIVE } from '../vfx/particle-pool.js';

export const POOL_PARTICLE = 'particle';

export class ParticleSimulationSystem implements System {
  readonly name: string = 'particle-simulation';
