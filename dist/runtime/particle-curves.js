...
export function emitRateAt(opts, t) {
    var ct = clampUnit(t);
...
export function particlesToEmit(opts, t0, t1, durationSeconds, accumulator) {
...
export function colorAtAge(stops, age) {
...
export function sizeAtAge(opts, t) {
    var ct = clampUnit(t);
...
//# sourceMappingURL=particle-curves.js.map