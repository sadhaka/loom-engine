...
export class MatchmakingPool {
    ...
    static create(opts = {}) {
        return new MatchmakingPool(opts);
    }
        ...
        while (!sv.done) {
            ...
            for (var i = 0; i + size <= bucket2.length; i++) {
                ...
                for (var k = 0; k < size; k++) {
                    var cand = bucket2[i + k];
                    if (matched.has(cand.id)) {
                        skip = true;
                        break;
                    }
                }
    ...
    getDefaultPartySize() { return this.defaultPartySize; }
    getInitialSkillRange() { return this.initialSkillRange; }
    getExpansionPerSec() { return this.expansionPerSec; }
    getMaxSkillRange() { return this.maxSkillRange; }
...
//# sourceMappingURL=matchmaking-pool.js.map