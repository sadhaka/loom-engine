...
export var ADV_AGAINST_TARGET = ['restrained', 'stunned', 'paralyzed', 'unconscious'];
// An ATTACKER with any of these has disadvantage on attack rolls.
export var DISADV_ON_ATTACKER = ['poisoned', 'frightened', 'restrained', 'prone'];
// These auto-fail STRENGTH and DEXTERITY saving throws (and only those).
export var AUTO_FAIL_STR_DEX = ['paralyzed', 'stunned', 'unconscious'];
