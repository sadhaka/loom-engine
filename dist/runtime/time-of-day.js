...
export class TimeOfDay {
    ...
    getPhase() { return this.currentPhaseName; }
    ...
    getDayLengthMs() { return this.dayLengthMs; }
    dispose() {
        this.phases = [];
    ...
    findPhaseForHour(hour) {
        ...
        if (current === null) {
            ...
            // last phase.
            var last = this.phases[this.phases.length - 1];
            current = last.name;
        }
        return current;
    }
