...
export function replayEvents(base, events, reducer, startIndex = 0) {
    ...
    for (var i = 0; i < events.length; i++) {
        state = reducer(state, events[i], startIndex + i);
    }
    return state;
}
...
export function replayFromSnapshot(key, snapshotState, snapshotIndex, eventsAfter, reducer) {
...
export function verifyReplayEquivalence(key, genesisState, allEvents, snapshotIndex, reducer) {
...
//# sourceMappingURL=world-replay.js.map