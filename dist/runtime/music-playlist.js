...
export class MusicPlaylist {
    ...
    addTrack(track) {
        ...
        var copy = { id: track.id, url: track.url };
        if (track.durationMs !== undefined)
            copy.durationMs = track.durationMs;
        if (track.loop !== undefined)
            copy.loop = track.loop;
        if (track.data)
    ...
    size() { return this.tracks.length; }
    list() {
...
function cloneTrack(t) {
    var copy = { id: t.id, url: t.url };
    if (t.durationMs !== undefined)
        copy.durationMs = t.durationMs;
    if (t.loop !== undefined)
        copy.loop = t.loop;
    if (t.data)
        copy.data = t.data;
...
//# sourceMappingURL=music-playlist.js.map