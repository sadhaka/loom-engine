...
export class VoronoiPartition {
    ...
    constructor(opts) {
        if (!(opts.width > 0))
            throw new Error('VoronoiPartition: width must be > 0');
        if (!(opts.height > 0))
            throw new Error('VoronoiPartition: height must be > 0');
        if (!(opts.count > 0) && !opts.sites)
            throw new Error('VoronoiPartition: count or sites must be provided');
    ...
    count() { return this.siteList.length; }
...
//# sourceMappingURL=voronoi-partition.js.map