...
export class Coroutine {
    ...
    start(genFn, opts = {}) {
        ...
        if (opts.onDone)
            entry.onDone = opts.onDone;
        if (opts.onError)
            entry.onError = opts.onError;
