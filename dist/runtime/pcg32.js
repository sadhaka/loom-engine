...
export class Pcg32 {
    ...
    static DEFAULT_STREAM = 0xda3e39cb94b95bdbn;
    state;
    inc;
    ...
    static fromRaw(rawState, rawInc) {
    ...
    snapshot() { return { state: this.state, inc: this.inc, draws: this.draws }; }
    restore(s) { this.state = s.state; this.inc = s.inc; this.draws = s.draws; }
...
function rotateRight32(x, r) {
    r = r & 31;
    if (r === 0)
        return x >>> 0;
    return ((x >>> r) | (x << (32 - r))) >>> 0;
}
//# sourceMappingURL=pcg32.js.map