...
export class CameraController {
    ...
    applyBounds() {
        ...
        if (minX > maxX) {
            ...
            if (this.view.centerX < minX)
                this.view.centerX = minX;
            else if (this.view.centerX > maxX)
                this.view.centerX = maxX;
        }
        var minY = b.y + halfH;
        ...
        if (minY > maxY) {
            ...
            if (this.view.centerY < minY)
                this.view.centerY = minY;
            else if (this.view.centerY > maxY)
                this.view.centerY = maxY;
        }
    }
}
