export declare const LOOM_ENGINE_VERSION = "3.0.0";
...
export type { ChainedRecord, EventChainOptions, ChainMismatch, ChainVerifyResult, ChainSeal, } from './runtime/event-chain.js';
...
export type { WorldState, WorldEntity, WorldStateSnapshot, SnapshotInput, } from './runtime/world-state-snapshot.js';
...
export type { ExprNode, MutationNode, DegreeCond, DegreeBranch, CheckNode, EvalContext, ActionResult, AppliedMutation, ParsedDice, } from './runtime/ruleset-ast.js';
...
export type { WorldAction, Ruleset, WorldActionProposal, ProposalMap, SerializedMutation, EpochActionEntry, EpochResolvedEvent, TickEpochInput, TickEpochResult, CatchUpInput, CatchUpResult, } from './runtime/world-epoch.js';
export { suspend, resume, replayEpochEvent, RESOURCE_WORLD_SESSION, } from './runtime/world-session.js';
export type { WorldBundle, SuspendInput, ResumeInput, ResumeResult, } from './runtime/world-session.js';
...
export type { CreatureSpec, BestiaryConfig, BestiaryIntegrations, } from './runtime/bestiary.js';
...
export type { SlotEntry, PactEntry, SlotPool, SpendResult, UpcastInfo, } from './runtime/srd5e-spell-slots.js';
...
export type { ConcentrationState, ConcChange, MaintainResult, } from './runtime/srd5e-concentration.js';
...
export type { CantripDef, LeveledDef, CastPlan, } from './runtime/srd5e-pack.js';
