...
// ----- Factory -----
export function createZoneBossEntityResource() {
...
export function buildEntityFromSpawn(env) {
...
function entityFromSpec(zoneId, boss, ts) {
    return {
        zone_id: zoneId,
...
export function applyTick(entity, env) {
...
//# sourceMappingURL=zone-boss-entity.js.map