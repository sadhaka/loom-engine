...
export function applyZoneStateChanges(res, zoneId, changes) {
    if (changes.length === 0)
        return;
...
// zone wholesale").
export function replaceZoneStateFromSnapshot(res, zoneId, state) {
    const fresh = new Map();
...
//# sourceMappingURL=zone-state-resource.js.map