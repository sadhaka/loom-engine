...
import { RESOURCE_DIRECTOR_BRIDGE, RESOURCE_KNOT_CONTEXT, } from './director-bridge.js';
import { RESOURCE_VEIL_BUDGET, RESOURCE_TIME, } from '../resources.js';
export const RESOURCE_DIRECTOR_LOG = 'director_log';
const RING_SIZE = 32;
export function createDirectorEventLog() {
    return {
        recent: [],
...
export class DirectorSystem {
    name = 'director';
    update(world, _dt) {
        const bridge = world.resources.get(RESOURCE_DIRECTOR_BRIDGE);
...
function applyEvent(ev, knotCtx, log, budget, nowMs, frameNow) {
    ...
    switch (ev.type) {
        ...
        case 've.budget.update': {
            ...
            if (budget) {
                ...
                if (frameNow >= 0)
                    budget.lastUpdatedFrame = frameNow;
            }
            break;
        }
...
//# sourceMappingURL=director-system.js.map